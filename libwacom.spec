...
Source0  : https://github.com/linuxwacom/libwacom/releases/download/libwacom-2.10.0/libwacom-2.10.0.tar.xz
Source1  : https://github.com/linuxwacom/libwacom/releases/download/libwacom-2.10.0/libwacom-2.10.0.tar.xz.sig
...
Patch1: 0001-Find-pytest-instead-of-pytest-3.patch
...
%prep
%setup -q -n libwacom-2.10.0
cd %{_builddir}/libwacom-2.10.0
%patch -P 1 -p1
pushd ..
cp -a libwacom-2.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707318604
