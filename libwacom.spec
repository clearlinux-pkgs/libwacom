...
Source0  : https://github.com/linuxwacom/libwacom/releases/download/libwacom-2.8.0/libwacom-2.8.0.tar.xz
Source1  : https://github.com/linuxwacom/libwacom/releases/download/libwacom-2.8.0/libwacom-2.8.0.tar.xz.sig
...
%prep
%setup -q -n libwacom-2.8.0
cd %{_builddir}/libwacom-2.8.0
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699917497
